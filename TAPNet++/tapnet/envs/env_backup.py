...
class TAP(gym.Env):
                 ...
                 reward_type='C', rotate_axes=['z'], \
                    unit_scale=1, stable_rule='hard_before_pack', stable_scale_factor=0.1, allow_unstable=False, \
                        same_height_threshold=0, min_ems_width=0, min_height_diff=0, ems_per_num = 8, \
                            ...
                            simulation_scene=None, init_ctn_num = None, corner_num=1
                        ):
    ...
    def generate_new_task(self):
        if self.fact_data_folder is not None:
            ...
            return
            '''
            # b1 = np.load("./data/240607-152830/logs_1_packed_seq.npy")[:,:3]
            b2 = np.load("./data/240607-163934/logs_1_packed_seq.npy")[:,:3]
            b3 = np.load("./data/240607-172624/logs_1_packed_seq.npy")[:,:3]
            b4 = np.load("./data/logs_1_2_packed_seq(1).npy")[:,:3]
            # b5 = np.load("./data/logs/RL/240614-141118/logs_1_2_packed_seq.npy")[:,:3]
            # b6 = np.load("./data/logs/RL/240614-152145/logs_1_2_packed_seq.npy")[:,:3]
            # b7 = np.load("./data/logs/RL/240614-141737/logs_1_2_packed_seq.npy")[:,:3]
            
            b8 = np.load("./data/240606-161204/logs_1_packed_seq.npy")[:, :3]
            b9 = np.load("./data/240615-094727/logs_1_2_packed_seq.npy")[:, :3]

            # bc = np.concatenate([b1, b2, b3, b4, b5, b6, b7], axis=0).astype('int')
            bc = np.concatenate([b2, b3, b4, b8, b9], axis=0).astype('int')
            '''
            bc = np.load("./data/240606-161204/logs_1_packed_seq.npy")[:, :3]
